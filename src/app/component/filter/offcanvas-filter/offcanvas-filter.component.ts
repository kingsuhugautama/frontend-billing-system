...
export interface OffcanvasFilter {
    filterBy: string;
    filterType: 'dropdown' | 'input' | 'datepicker';
    columnName: string;
    filter: 'like' | 'equal' | 'betweeen';
    searchText: string;
    searchText2: string;
}
...
@Component({
    ...
    styleUrls: ['./offcanvas-filter.component.css']
})
export class OffcanvasFilterComponent implements OnInit {
